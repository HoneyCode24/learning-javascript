/* Question 1 print all the even number between 0-100 */
for(let i=0; i<=100;i++){
    if(i%2 == 0){
...
/*Question 2 create a game where you start game with some random and then ask the user to guess the number and the games continues untill the user guess the correct number. */
